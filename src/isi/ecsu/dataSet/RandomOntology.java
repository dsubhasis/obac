...
public class RandomOntology {
	...
	public OntModel GenerateOntology(int n)
	{
		...
		uri = "http://www.iwi-iuk.org/material/RDF/Schema/Class/scf#Rand"; // take it as an argument
	...
	public static void main(String[] args) {
		...
		RandomOntology r = new RandomOntology(100);
		OntModel o = r.GenerateOntology();
		o.write(System.out);
		
		File ontologyOutput = new File("/ontology_1L.owl");
