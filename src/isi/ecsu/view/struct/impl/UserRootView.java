...
public class UserRootView {
	...
	public ViewObject getUserView(ViewObject vo, String parent , String child, String user, String rootElement, String requestFile, String policyFile[], String graphName, String parentURI) throws Throwable{
